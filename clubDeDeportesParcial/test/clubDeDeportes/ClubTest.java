...
public class ClubTest {
	...
	public void  queSePuedaCrearUnCiclista() {
		...
		assertEquals(TipoDeBicicleta.RUTA, nuevo.getTipoDeBicicleta()); // switch en caso de que sea return con string lo 100to
		assertEquals((Integer) 3, nuevo.getNumeroDeSocio());
	}

	@Test
	public void  queSePuedaCrearUnTriatleta() {
		Triatleta nuevo = new Triatleta(4, "Luna", 10000, TipoDeBicicleta.TRIA);
	...
	public void  queSePuedanIncorporarDistintosDeportistas() {
		...
		actual.agregarDeportista(new Triatleta(1004, "Tamara", 1000, TipoDeBicicleta.RUTA));
		...
		actual.agregarDeportista(new Triatleta(1004, "Cecilia", 400, TipoDeBicicleta.TRIA));
