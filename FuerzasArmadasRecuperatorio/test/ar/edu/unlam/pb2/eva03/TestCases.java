...
public class TestCases {
	...
	public void queSePuedaArmarElConvoy() {
		...
		assertEquals((Integer)13, argentina.getCapacidadDeDefensa()); // hice hashcode y equals y da 13 en realidad.
	}
	...
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible {
		...
		try {
			assertFalse(argentina.enviarALaBatalla("Pacifico", 10)); // puse assertfalse pues tiene que dar falso destructor es volador no acuatico		
			assertFalse(argentina.enviarALaBatalla("Pacifico", 11)); // puse assertfalse pues tiene que dar falso destructor es volador no acuatico		
